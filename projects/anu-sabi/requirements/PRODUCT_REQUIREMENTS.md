...
This document describes **current behavior only**. Planned features are noted separately.
...
The following use status **Planned** or **Stub** — documented for context only:

| Feature | Status |
|---------|--------|
| Online multiplayer / accounts | Planned — not in repository |
| Real leaderboard backend | Planned — not in repository |
| Premium subscription | Stub (`ComingSoonScreen`) |
| Pro deck purchases | Stub (`DeckPromoBanner`) |
| Analytics / telemetry | Planned — not in repository |
